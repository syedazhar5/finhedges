...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto my-5">
        <h1 class="display-3 font-weight-normal">Welcome To <span class="text-success">FinHedges</span></h1>
        <p class="lead font-weight-normal ">Join the fastest growing community.<br>Enroll now for FREE.</p>
        <a class="btn btn-outline-success btn-lg" href="registration.php">Click Here to Register</a>
    </div>
