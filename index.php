...
<html lang="en">
  ...
  <body>
  <nav class="navbar navbar-expand-md navbar-dark justify-content-center fixed-top bg-dark">
  ...
  <img src="images\icon-01.jpg" class="rounded-circle" width="45" height="45" href="index.php" alt="logo">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          <a class="nav-link active" href="#">Angel Broking</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex">
        <button class="btn btn-outline-success" type="submit">iLearn</button>
      </form>
    </div>
  </div>
 </nav>
